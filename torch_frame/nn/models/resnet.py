...
class ResNet(Module):
    ...
    def forward(self, tf: TensorFrame, add_noise: bool = False,          # ✅ 新增参数
        sigma_ratio: float = 0.1, phase="test", is_last_batch=False) -> Tensor:
        ...
        """
        x, _ = self.encoder(tf, add_noise=add_noise, sigma_ratio=sigma_ratio, phase=phase, is_last_batch=is_last_batch)
